...
namespace Microsoft.AspNetCore.Mvc.Analyzers
{
    internal static class SymbolApiResponseMetadataProvider
    {
        ...
        private static readonly IList<DeclaredApiResponseMetadata> DefaultResponseMetadata = new[]
        {
            new DeclaredApiResponseMetadata(statusCode: 200, attributeData: null, attributeSource: null, @implicit: true),
        };
            ...
            IMethodSymbol method)
        {
            ...
            if (metadataItems.Count == 0)
            {
                ...
                metadataItems = DefaultResponseMetadata;
            }
